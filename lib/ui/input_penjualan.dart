  ...
  Future<http.Response> adddata(index) async {
    ...
    if (index == null) {
      ...
      final http.Response response = await http
          .post("http://192.168.1.7/apiflutter/api/Penjualan/save", body: {
        ...
        'jenis Jam_Tangan': keteranganController.text,
      ...
      final http.Response response = await http.post(
          "http://192.168.1.7/apiflutter/api/Penjualan/save_update",
          body: {
            'id': widget.list['id'],
            'nama': namaController.text,
            'jenis Jam_Tangan': keteranganController.text,
...
//maka controller diisi dengan nilai dari variabel list sesuai dengan index dan name variabel
      ...
      keteranganController =
          TextEditingController(text: widget.list['jenis Jam Tangan']);
